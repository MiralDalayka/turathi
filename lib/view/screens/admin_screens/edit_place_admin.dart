        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              Text("Likes: ${widget.placeModel.likesList!.length}",style: style),
                Text("latitude: ${widget.placeModel.latitude} ",style: style),
                Text("longitude: ${widget.placeModel.longitude} ",style: style),
...
Row(
  ...
  children: [
    TextButton.icon(onPressed: (){
      setState(() {
        widget.placeModel.isVisible=!widget.placeModel.isVisible!;
      });
    }, icon: Icon(
        ...
        label: widget.placeModel.isVisible!?Text("Hide Place"):Text("View Place")
    ),
    ElevatedButton(
      onPressed: () async {
        if(data ==null){
